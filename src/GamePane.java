...
public class GamePane extends Pane {
    ...
    private void createGameBoard() {
        ...
        for (int i = 0; i < boardButtons.length; i++) {
            ...
            boardButtons[i].setFocusTraversable(true);
            ...
            boardButtons[i].addEventHandler(ActionEvent.ACTION, (ActionEvent e) -> {
                actionPerformed(e);
            });
